...
class rippleUtils extends View {
    ...
    render() {
        ...
        if (this.showRipple) {
            If.branchId(0);
            Flex.create();
            Flex.debugLine("components/Ripple.ets(65:7)");
            ...
            Circle.create();
            Circle.debugLine("components/Ripple.ets(66:9)");
...
/*!********************************************************************************************************************!*\
  !*** F:\DevEcoStudioProjects\BottomNavigation\BottomNavigation\src\main\ets\components\BottomNavigation.ets?entry ***!
  \********************************************************************************************************************/
...
class BottomNavigation extends View {
    ...
    render() {
        Row.create();
        Row.debugLine("components/BottomNavigation.ets(33:5)");
        Row.clip(true);
        Row.width('100%');
...
class NavigationItem extends View {
    ...
    render() {
        Stack.create();
        Stack.debugLine("components/BottomNavigation.ets(71:5)");
        Stack.clip(true);
        Stack.height('100%');
        Stack.width(this.bottomNavigationModel.itemWidth);
        Column.create({ space: '5vp' });
        Column.debugLine("components/BottomNavigation.ets(72:7)");
        Column.width('100%');
        Column.height('100%');
        ...
        Column.create();
        Column.debugLine("components/BottomNavigation.ets(73:9)");
        Column.alignItems(HorizontalAlign.Center);
        ...
        Badge.debugLine("components/BottomNavigation.ets(74:13)");
        ...
        Image.debugLine("components/BottomNavigation.ets(78:15)");
        ...
        Text.debugLine("components/BottomNavigation.ets(95:9)");
